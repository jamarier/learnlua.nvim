...
The Lua reference manual describes coroutines as follows: _"Lua supports
...
- Values passed to the _next_ `resume` become the return values of `yield`.
...
- Returns a _function_ that resumes it
